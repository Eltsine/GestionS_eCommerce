...
class CategorieResourceIT {
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie().code(DEFAULT_CODE).designation(DEFAULT_DESIGNATION);
        return categorie;
    }
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie().code(UPDATED_CODE).designation(UPDATED_DESIGNATION);
        return categorie;
    }
    ...
    void putNewCategorie() throws Exception {
        ...
        updatedCategorie.code(UPDATED_CODE).designation(UPDATED_DESIGNATION);
    ...
    void partialUpdateCategorieWithPatch() throws Exception {
        ...
        partialUpdatedCategorie.code(UPDATED_CODE).designation(UPDATED_DESIGNATION);
