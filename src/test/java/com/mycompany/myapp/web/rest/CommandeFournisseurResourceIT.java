...
class CommandeFournisseurResourceIT {
    ...
    public static CommandeFournisseur createEntity(EntityManager em) {
        CommandeFournisseur commandeFournisseur = new CommandeFournisseur().code(DEFAULT_CODE).dateCommande(DEFAULT_DATE_COMMANDE);
    ...
    public static CommandeFournisseur createUpdatedEntity(EntityManager em) {
        CommandeFournisseur commandeFournisseur = new CommandeFournisseur().code(UPDATED_CODE).dateCommande(UPDATED_DATE_COMMANDE);
        return commandeFournisseur;
    }
    ...
    void createCommandeFournisseur() throws Exception {
        ...
        assertThat(testCommandeFournisseur.getCode()).isEqualTo(DEFAULT_CODE);
        assertThat(testCommandeFournisseur.getDateCommande()).isEqualTo(DEFAULT_DATE_COMMANDE);
    }
    ...
    void putNewCommandeFournisseur() throws Exception {
        ...
        updatedCommandeFournisseur.code(UPDATED_CODE).dateCommande(UPDATED_DATE_COMMANDE);
        ...
        CommandeFournisseur testCommandeFournisseur = commandeFournisseurList.get(commandeFournisseurList.size() - 1);
        assertThat(testCommandeFournisseur.getCode()).isEqualTo(UPDATED_CODE);
        assertThat(testCommandeFournisseur.getDateCommande()).isEqualTo(UPDATED_DATE_COMMANDE);
    }
    ...
    void partialUpdateCommandeFournisseurWithPatch() throws Exception {
        ...
        partialUpdatedCommandeFournisseur.dateCommande(UPDATED_DATE_COMMANDE);
    ...
    void fullUpdateCommandeFournisseurWithPatch() throws Exception {
        ...
        partialUpdatedCommandeFournisseur.code(UPDATED_CODE).dateCommande(UPDATED_DATE_COMMANDE);
