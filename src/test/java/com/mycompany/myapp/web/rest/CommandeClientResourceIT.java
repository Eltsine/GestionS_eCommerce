...
class CommandeClientResourceIT {
    ...
    public static CommandeClient createEntity(EntityManager em) {
        CommandeClient commandeClient = new CommandeClient().code(DEFAULT_CODE).dateCommande(DEFAULT_DATE_COMMANDE);
    ...
    public static CommandeClient createUpdatedEntity(EntityManager em) {
        CommandeClient commandeClient = new CommandeClient().code(UPDATED_CODE).dateCommande(UPDATED_DATE_COMMANDE);
        return commandeClient;
    }
    ...
    void createCommandeClient() throws Exception {
        ...
        assertThat(testCommandeClient.getCode()).isEqualTo(DEFAULT_CODE);
    ...
    void putNewCommandeClient() throws Exception {
        ...
        updatedCommandeClient.code(UPDATED_CODE).dateCommande(UPDATED_DATE_COMMANDE);
        ...
        CommandeClient testCommandeClient = commandeClientList.get(commandeClientList.size() - 1);
        assertThat(testCommandeClient.getCode()).isEqualTo(UPDATED_CODE);
    ...
    void fullUpdateCommandeClientWithPatch() throws Exception {
        ...
        partialUpdatedCommandeClient.code(UPDATED_CODE).dateCommande(UPDATED_DATE_COMMANDE);
