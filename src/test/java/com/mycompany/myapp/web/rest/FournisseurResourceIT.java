...
class FournisseurResourceIT {
    ...
    void createFournisseur() throws Exception {
        ...
        assertThat(testFournisseur.getNumTel()).isEqualTo(DEFAULT_NUM_TEL);
    ...
    void putNewFournisseur() throws Exception {
        ...
        assertThat(testFournisseur.getNumTel()).isEqualTo(UPDATED_NUM_TEL);
    ...
    void partialUpdateFournisseurWithPatch() throws Exception {
        ...
        partialUpdatedFournisseur.prenom(UPDATED_PRENOM).mail(UPDATED_MAIL).numTel(UPDATED_NUM_TEL);
