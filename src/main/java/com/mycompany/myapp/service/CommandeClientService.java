...
public class CommandeClientService {
    ...
    public CommandeClientService(CommandeClientRepository commandeClientRepository, CommandeClientMapper commandeClientMapper) {
    ...
    /**
     * Partially update a commandeClient.
     *
    ...
    /**
     * Delete the commandeClient by id.
     *
     * @param id the id of the entity.
     */
