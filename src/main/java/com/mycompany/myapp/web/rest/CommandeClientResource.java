...
public class CommandeClientResource {
    ...
    public ResponseEntity<CommandeClientDTO> updateCommandeClient(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, commandeClientDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/commande-clients/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<CommandeClientDTO> partialUpdateCommandeClient(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, commandeClientDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<CommandeClientDTO>> getAllCommandeClients(Pageable pageable) {
