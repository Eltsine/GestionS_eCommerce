...
public class PersonnelResource {
    ...
    public ResponseEntity<PersonnelDTO> updatePersonnel(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, personnelDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PersonnelDTO> partialUpdatePersonnel(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, personnelDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<PersonnelDTO>> getAllPersonnel(Pageable pageable) {
