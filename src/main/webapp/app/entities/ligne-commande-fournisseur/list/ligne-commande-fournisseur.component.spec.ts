...
describe('Component Tests', () => {
  describe('LigneCommandeFournisseur Management Component', () => {
    let comp: LigneCommandeFournisseurComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LigneCommandeFournisseurComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ligneCommandeFournisseurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
