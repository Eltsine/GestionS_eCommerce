...
export class CommandeFournisseurService {
  ...
  protected convertDateFromClient(commandeFournisseur: ICommandeFournisseur): ICommandeFournisseur {
    return Object.assign({}, commandeFournisseur, {
      dateCommande: commandeFournisseur.dateCommande?.isValid() ? commandeFournisseur.dateCommande.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((commandeFournisseur: ICommandeFournisseur) => {
        commandeFournisseur.dateCommande = commandeFournisseur.dateCommande ? dayjs(commandeFournisseur.dateCommande) : undefined;
      });
    }
    return res;
  }
