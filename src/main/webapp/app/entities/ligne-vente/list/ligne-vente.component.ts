...
export class LigneVenteComponent implements OnInit {
  ...
  trackId(index: number, item: ILigneVente): number {
    return item.id!;
  }

  delete(ligneVente: ILigneVente): void {
    const modalRef = this.modalService.open(LigneVenteDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ILigneVente[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
