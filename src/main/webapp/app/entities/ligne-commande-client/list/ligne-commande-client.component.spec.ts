...
describe('Component Tests', () => {
  describe('LigneCommandeClient Management Component', () => {
    let comp: LigneCommandeClientComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LigneCommandeClientComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ligneCommandeClients?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
